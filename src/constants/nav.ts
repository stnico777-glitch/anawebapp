...
export const PRIMARY_NAV_LINK_CLASS =
  "text-xs font-medium uppercase tracking-wider text-foreground hover:text-sky-blue focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-sky-blue focus-visible:ring-offset-2 focus-visible:rounded-sm";

/** Mobile dropdown variant */
export const PRIMARY_NAV_LINK_CLASS_MOBILE =
  "rounded-sm py-2 text-xs font-medium uppercase tracking-wider text-foreground hover:bg-background hover:text-sky-blue";
